 ...
 * Plugin URI:        http://www.autotagger.thedemo.co
...
<?php
    ...
    <ul class="products-list">
		...
		<tr>
		 ...
		 <input type="hidden" class="product_image" value="<?php echo the_post_thumbnail_url() ; ?>">
		 </td>
		 <td colspan="1" ><?php echo the_id(); ?></td>
		 <td colspan="2" ><?php the_post_thumbnail( array(100,100), ['class' =>  'attachment-thumbnail size-thumbnail wp-post-image'] );  ?></td>
...
<script type='text/javascript'>
	jQuery( document ).ready( function( $ ) {
       ...
       jQuery( '#woo-products' ).on( 'click', function() {
		...
		jQuery('.product_image').each(function(index, elem) {
            images_urls.push($(elem).val());
        });
